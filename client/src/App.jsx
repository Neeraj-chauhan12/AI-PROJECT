...
const features = [
  {
    ...
    description: 'Start your journey in seconds with a clean and simple experience.',
  },
  {
    title: 'Smart dashboard',
    description: 'Stay productive with a beautiful workspace designed for modern teams.',
  },
  {
    title: 'Secure access',
    description: 'Enjoy trusted sign-in options and a polished authentication flow.',
  },
]

// const HomeScreen = ({ name, onLogout }) => {
//   return (
